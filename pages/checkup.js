...
export default function CheckupPage() {
  ...
  // Verifica autenticazione (stesso codice delle altre pagine)
  ...
  // Icone (stesso set delle altre pagine)
  ...
  const handleSubmit = async (e) => {
    ...
    // TODO: Implementare invio dati a Supabase e GPT
    alert('Form inviato! (implementazione in corso...)');
  };
            ...
            <div className="py-6 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center space-x-4 mb-8">
                  <div className={`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${currentStep >= 1 ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-600'}`}>
                  ...
                  <div className={`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${currentStep >= 2 ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-600'}`}>
                    <Icon path={icons.upload} className="w-4 h-4" />
                    <span>Documenti</span>
                  </div>
                  <div className={`w-8 h-px ${currentStep >= 3 ? 'bg-blue-600' : 'bg-slate-300'}`}></div>
                  <div className={`flex items-center space-x-2 px-3 py-1 rounded-full text-sm ${currentStep >= 3 ? 'bg-blue-600 text-white' : 'bg-slate-200 text-slate-600'}`}>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input type="text" name="company_name" required value={formData.company_name} onChange={handleInputChange}
                      ...
                      <div>
                        ...
                        <input type="text" name="vat_number" value={formData.vat_number} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          placeholder="IT..." />
                      </div>
                      ...
                      <div>
                        ...
                        <select name="industry_sector" required value={formData.industry_sector} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                      ...
                      <div>
                        ...
                        <select name="company_size" required value={formData.company_size} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                      ...
                      <div>
                        ...
                        <input type="number" name="employee_count" value={formData.employee_count} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          placeholder="es. 15" />
                      </div>
                      ...
                      <div>
                        ...
                        <select name="revenue_range" value={formData.revenue_range} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                      ...
                      <div>
                        ...
                        <input type="text" name="location_city" value={formData.location_city} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          placeholder="Milano" />
                      </div>
                      ...
                      <div>
                        ...
                        <input type="text" name="location_region" value={formData.location_region} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    ...
                    <div className="mt-6">
                      <label className="block text-sm font-medium text-slate-700 mb-2">Sito Web</label>
                    ...
                    <div className="mt-6">
                      ...
                      <textarea name="description" rows={4} value={formData.description} onChange={handleInputChange}
                        className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                        placeholder="Descrivi brevemente la tua attività, i prodotti/servizi offerti..."></textarea>
                    </div>
                  </div>

                  {/* Sezione 2: Obiettivi e Sfide */}
                  <div className="border-t pt-8">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <textarea name="main_challenges" rows={3} value={formData.main_challenges} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          placeholder="Quali sono le principali difficoltà che stai affrontando? (es. costi elevati, competizione, mancanza di visibilità...)"></textarea>
                      </div>

                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">Obiettivi di Business</label>
                        <textarea name="business_goals" rows={3} value={formData.business_goals} onChange={handleInputChange}
                          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                          placeholder="Quali sono i tuoi obiettivi per i prossimi 12-24 mesi? (es. aumentare fatturato, espansione, ottimizzazione costi...)"></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-t pt-8">
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-slate-600">
                        I dati verranno utilizzati per generare un'analisi AI personalizzata della tua azienda.
                      </p>
                      <button type="submit"
