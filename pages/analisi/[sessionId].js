...
// VERSIONE 2.3: Grafico Fatturato.
// - Sostituisce il grafico dell'andamento ROE con l'andamento del Fatturato.
// - Aggiunge la formattazione in Euro (€) all'asse Y e al tooltip del grafico.
// - Aggiorna il titolo e il colore del grafico.
...
    <>
      <Head>
        <title>Report Analisi AI V2.3 - PMIScout</title>
...
// --- Componente Grafico Aggiornato ---
const TrendChart = ({ data, dataKey, name, color }) => {
    // Controllo per la libreria Recharts
...
                    <YAxis tick={{ fontSize: 12 }} tickFormatter={currencyFormatter} width={80} />
                    <Tooltip 
                        contentStyle={{ fontSize: 12, borderRadius: '0.5rem', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)' }} 
                        formatter={(value) => [currencyFormatter(value), name]}
                    />
...
// --- Sezione Metriche e Grafico (AGGIORNATA) ---
...
                })}
                
                {/* MODIFICA: Controlla e visualizza il grafico del fatturato invece del ROE */}
...
                        <h3 className="text-base font-semibold text-slate-800">Andamento Fatturato (€)</h3>
                        <TrendChart 
...
// Il componente SwotSection non è stato modificato, ma lo includo per completezza
