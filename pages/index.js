  ...
  return (
    <>
      <Head>
        ...
        {/* Script Principale di Outseta con la nuova opzione di callback */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
              var o_options = {
                ...
                tokenStorage: 'cookie',
                auth: {
                  authenticationCallbackUrl: 'https://pmiscoutai.vercel.app/'
                }
              };
            `,
          }}
            ...
            <div className="py-6 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col pb-6 border-b md:flex-row md:items-center md:justify-between border-slate-200">
                ...
                <div className="flex items-center mt-4 space-x-3 md:mt-0">
                  {/* I link qui usano ancora il dominio di Outseta, ma il problema di sessione potrebbe persistere */}
